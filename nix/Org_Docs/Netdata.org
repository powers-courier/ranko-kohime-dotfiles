* TODO Netdata
#+begin_src nix :tangle ../modules/netdata.nix
{ config, lib, ... }: {
  options.netdata.enable = lib.mkEnableOption "Enable Netdata" //
    { default = false; };
...
** TODO Config
#+begin_src nix :noweb-ref netdata-config
<<netdata-global>>
<<netdata-web>>
<<netdata-plugins>>
#+end_src
...
*** Global
#+begin_src nix :noweb-ref netdata-global
global = {
  "run as user" = "netdata";
...
*** Web
#+begin_src nix :noweb-ref netdata-web
web = {
  "default port" = 19999;
...
*** Plugins
#+begin_src nix :noweb-ref netdata-plugins
plugins = {
